 ...
 */
public class DepartureFinder extends AsyncTask {
    final String TAG = "DepartureFinder";
    ArrayList<Departure> departures;
    @Override
    protected void onPostExecute(Object o) {
        super.onPostExecute(o);
        mListener.departureFindFinish(departures);
    }
    DepartureResponse mListener;

    public void setListener(DepartureResponse listener){
        mListener = listener;
    }
    @Override
    protected Object doInBackground(Object[] params) {
        ...
        HttpGet httpget = new HttpGet("http://www.labs.skanetrafiken.se/v2.2/stationresults.asp?selPointFrKey=" + mListener.getStation().getId()); //"www.labs.skanetrafiken.se/v2.2/trafficmeans.asp");
        try {
